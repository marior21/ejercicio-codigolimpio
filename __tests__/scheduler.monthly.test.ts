...
describe('scheduler monthly', () => {
  test.each([
    [new Date(2020, 4, 4), 3, TimeUnit.Hours, new Date(2020, 4, 7, 4, 0, 0), new Date(2020, 4, 7, 7, 0, 0)],
    // [new Date(2020, 4, 4, 19), 3, TimeUnit.Hours, new Date(2020, 4, 7, 4, 0, 0), new Date(2020, 7, 7, 4, 0, 0)],
    // [new Date(2020, 4, 5, 5), 3, TimeUnit.Hours, new Date(2020, 4, 7, 8, 0, 0), new Date(2020, 7, 7, 4, 0, 0)],
    // [new Date(2020, 4, 5, 5), 3, TimeUnit.Hours, new Date(2020, 4, 7, 8, 0, 0), new Date(2020, 7, 7, 4, 0, 0)],
    ...
    (inputDate: Date, occursEveryNumber: number, timeUnit: TimeUnit, expectedDate: Date, nextMonthsExpectedDate: Date) => {
      ...
      const monthlyConfiguration: MonthlyConfiguration = new MonthlyConfiguration(MonthlyFrecuencyType.exactDay, 7, 3, null, null);
      const configuration: Configuration = new Configuration(SchedulerType.Recurring, true, Occurs.Monthly, null, limits, null, dailayConfiguration, monthlyConfiguration);
